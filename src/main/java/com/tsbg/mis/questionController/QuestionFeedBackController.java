package com.tsbg.mis.questionController;
...
import com.tsbg.mis.powerService.ProjectService2;
...
import com.tsbg.mis.questionService.QuestionHandleService2;
...
public class QuestionFeedBackController {
    @Autowired
    private QuestionFeedBackService2 feedBackService;
    @Autowired
    private QuestionHandleService2 questionHandleService;
    @Autowired
    ...
    public ResultUtils addFeedBack(HttpServletRequest req, MultipartFile[] file)throws Exception {//
        ...
        QuestionFeedback2 questionFeedback = JSONObject.parseObject(json, QuestionFeedback2.class);
...
//        questionFeedback.setUserName(req.getParameter("userName"));
        ...
        if (feedBackService.insertSelective(questionFeedback)>0) {
            ...
            QuestionHandle2 questionHandle=new QuestionHandle2();
                    ...
                    for (MultipartFile multipartFile : file) {
                        ...
                        if (Suffix.equals(".xls") || Suffix.equals(".xlsx") || Suffix.equals(".xlsm") || Suffix.equals(".doc")
                            ...
                            if(prefixName==null) {
                                ...
                                fileInfo.setRelTableName("question_feedback");
                                fileInfo.setRelDocId(questionFeedback.getQuestionFeedbackId());
...
//                }
    ...
    @PassToken
    @ResponseBody
    public String getProjectName(@RequestBody QuestionFeedback2 questionFeedback){
    ...
    @PassToken
    @ResponseBody
    public List<QuestionFeedback2> getAllQuestionFeedBack(){
        //初始化參數構造器
        ResultUtils resultUtils = null;
        //獲取數據
    ...
    @PassToken
    @ResponseBody
    public List getQuestionFeedBackById(@RequestBody QuestionFeedback2 questionFeedback){
        //初始化參數構造器
        ResultUtils resultUtils = null;
        //獲取數據
...
//    }
    ...
    @UserLoginToken
    @ResponseBody
    public QuestionHandle2 getQuestionHandleId(@RequestBody QuestionFeedback2 questionFeedback)throws Exception {
        //初始化參數構造器
        ResultUtils resultUtils = null;
        //獲取數據
    ...
    public ResultUtils questionHandle(HttpServletRequest req, MultipartFile[] file)throws Exception {
        ...
        QuestionHandle2 questionHandle = JSONObject.parseObject(json, QuestionHandle2.class);
            ...
            for (MultipartFile multipartFile : file) {
                ...
                if (Suffix.equals(".xls") || Suffix.equals(".xlsx") || Suffix.equals(".xlsm") || Suffix.equals(".doc")
                    ...
                    if(prefixName==null) {
                        ...
                        fileInfo.setKeyword(multipartFile.getOriginalFilename());
                        fileInfo.setRelTableName("question_handle");
                        fileInfo.setRelDocId(questionHandle.getQuestionFeedbackId());
                        String timeFormat = sdf.format(new Date());
