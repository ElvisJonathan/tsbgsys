...
import com.tsbg.ecosys.common.CustomSessionManager;
import com.tsbg.ecosys.filter.CorsFilter;
...
public class ShiroConfiguration {
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
		...
		filterMap.put("cors",new CorsFilter()); //跨域
		filterMap.put("auth", new AjaxPermissionsAuthorizationFilter());
		...
		filterChainDefinitionMap.put("/tsbg/register/ecosign", "anon");
		...
		filterChainDefinitionMap.put("/**", "cors,anon");
